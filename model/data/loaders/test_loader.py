from model.data.loaders.loader import DataLoader
from model.data.samplers.CaFBI_sampler import test_sample
...
class TestDataLoader(DataLoader):
    ...
    def _batch_sampling_seq(self, batch_user_ids):
        ...
        for uid in batch_user_ids:
            one_sample = test_sample(uid, self.dataset, self.seqlen,
