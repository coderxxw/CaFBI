    ...
    def fit(self, data):
        ...
        with open(metrics_path, 'w') as f:
            header = 'epoch,lr,train_loss,val_loss,'\
                     'ndcg@1,ndcg@2,ndcg@5,ndcg@10,ndcg@15,ndcg@20,'\
                     'hr@1,hr@2,hr@5,hr@10,hr@15,hr@20,'\
            ...
            for ep in range(self.n_epochs):
                ...
                # Use ndcg at top_k = 10 to decide whether to save the model
                if best_valid_score < score[0][1] or ep == 1:
                    save_model = True
                    best_valid_score = score[0][1]
                    best_ep = ep
                else:
                    save_model = False
